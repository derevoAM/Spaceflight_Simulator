...
class Stage:
    ...
    def __init__(self, payload_mass, current_stage_mass, gas_exhaust_speed, fuel_consumption):
        """
        Class initializer
        :param payload_mass: mass of payload
        :param current_stage_mass: mass of stage
        :param gas_exhaust_speed: speed of gas exhaust
        :param fuel_consumption: engine fuel consumption value
        """
    ...
    def reduce_mass(self, step):
        ...
        """
        if self.current_stage_mass > self.payload_mass:
